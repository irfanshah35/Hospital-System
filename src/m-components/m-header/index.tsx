      ...
      >
        <div className={` w-full`}>
          ...
          >
            ...
            <div
              className={`flex items-center gap-[10px] px-[10px] transition-normal duration-300`}
            >
              <img
          ...
          {headColapsed ? (
            ...
            <div className="flex items-center justify-end w-full pl-[8px]">
              {/* Header Icons */}
...
const Notification = () => {
  ...
  return (
    <>
      <div className="absolute top-[50px] right-[-140px] w-[325px] bg-white shadow-xl rounded-[8px] border border-gray-200 overflow-hidden">
