...
export default function MobileHeader({ isMobileMenuOpen, setIsMobileMenuOpen }: MobileHeaderProps) {
  ...
  const [headColapsed, setHeadColapsed] = useState(false);
  ...
  return (
    <>
      <nav
        className={`fixed top-0 h-auto left-0 z-50 w-full md:hidden ${getHeaderBgClass()} shadow-[3px_0_10px_#b7c0ce33] font-['Roboto',_sans-serif] transition-colors duration-300`}
      >
        <div className={` w-full`}>
          {/* Logo Section */}
          <div
            className={`p-[8px] py-[12px] !pr-0 flex justify-between items-center ${sidebarTheme === "dark"
          ...
          >
            ...
            <div
              className={`flex items-center gap-[10px] relative top-[5px] left-[8px] px-[10px] transition-normal duration-300`}
            >
              <img
            ...
            <button className="mr-7" onClick={() => setHeadColapsed(!headColapsed)}>
              <ArrowDownUp className="w-5 h-5 " />
            </button>
          </div>
          {headColapsed ? (

            <div className="flex items-center mt-2 justify-end w-full pl-[8px]">
              {/* Header Icons */}
              <div className="flex items-center">
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {countryDropdown && (
                    <div className="absolute top-[45px] right-[-100px] z-10">
...
const Notification = () => {
  ...
  return (
    <>
      <div className="absolute top-[45px] right-[-140px] w-[325px] bg-white shadow-xl rounded-[8px] border border-gray-200 overflow-hidden">
