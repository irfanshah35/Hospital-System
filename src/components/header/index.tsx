      ...
      <nav className="fixed top-0 h-auto left-0 z-50 w-full bg-white shadow-[3px_0_10px_#b7c0ce33] font-['Roboto',_sans-serif]">
        <div className="flex items-center w-full max-w-[1400px] mx-auto py-[4px]">
          <div className="p-[8px] !pr-0 flex items-center">
            ...
            <div
              className={`flex items-center gap-[10px] px-[10px] mr-4 ${shouldExpand ? "w-[244px] justify-center" : "px-0 justify-center"
          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center">
              <button
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="w-[24px] h-6">
              ...
              {/* notification code  */}
              <div ref={ref}>
                <button onClick={() => setNotificationDropdown(!notificationDropdown)} className="relative text-gray-600 hover:text-gray-900 flex justify-center items-center w-[48px] h-[48px] cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
...
`}</style>
              ...
              <div className="" ref={dropdownRef}>
                ...
                {countryDropdown && (
                  <div className="absolute top-[50px] right-0 z-10 origin-top-left transform transition-all duration-300 ease-out" style={{
              ...
              {/* profile code  */}
              <div ref={profileRef}>
                <div onClick={() => setProfileDropdown(!profileDropdown)} className="w-[131px] h-[48px] flex justify-center items-center gap-2 cursor-pointer">
                ...
                {profileDropdown && (
                  <div className="absolute top-[50px] right-0 z-10 origin-top-right transform transition-all duration-300 ease-out" style={{
                      ...
                      <div className="menu">
                        <div className="user_dw_menu flex flex-col">
                          ...
                          <button
                            className="flex items-center gap-3 h-[48px] px-4 py-2 hover:bg-[#DEDCDF] transition-colors text-gray-700 text-sm font-medium cursor-pointer"
                          >
                            <svg className="w-[18px] h-[18px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M20 22H18V20C18 18.3431 16.6569 17 15 17H9C7.34315 17 6 18.3431 6 20V22H4V20C4 17.2386 6.23858 15 9 15H15C17.7614 15 20 17.2386 20 20V22ZM12 13C8.68629 13 6 10.3137 6 7C6 3.68629 8.68629 1 12 1C15.3137 1 18 3.68629 18 7C18 10.3137 15.3137 13 12 13ZM12 11C14.2091 11 16 9.20914 16 7C16 4.79086 14.2091 3 12 3C9.79086 3 8 4.79086 8 7C8 9.20914 9.79086 11 12 11Z"></path></svg>
                            Account
                          </button>
    ...
    <>
      <div className="absolute top-[50px] right-[10px] w-[325px] bg-white shadow-xl !rounded-[6px] border border-gray-200 overflow-hidden">
        <div className="flex justify-between items-center px-[15px] py-[18px] bg-[#6777ef] text-white">
          ...
          <a className="text-[12px] cursor-pointer font-medium hover:underline">Mark all as read</a>
        </div>
        ...
        <div className="max-h-[350px] overflow-y-auto scrollbar-hide">
          <div className="divide-y divide-gray-100">
            ...
            {notifications.map((item, i) => (
              ...
              <div key={i} className="flex items-center gap-[24px] p-[10px] px-[18px] mb-[3px] hover:bg-[#F5F5F5] transition-colors cursor-pointer">
                <span className="flex items-center justify-center w-9 h-9 rounded-full text-green-600">
                  <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M3 3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3ZM20 7.23792L12.0718 14.338L4 7.21594V19H20V7.23792ZM4.51146 5L12.0619 11.662L19.501 5H4.51146Z"></path></svg>
                </span>
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-800">{item.title}</p>
                  <p className="text-xs text-gray-500 flex items-center gap-1">
                    <svg className="w-3 h-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20ZM13 12H17V14H11V7H13V12Z"></path></svg> {item.time}
                  </p>
        ...
        <div className="px-[15px] py-[12px] !bg-[#EFEDF0] text-center">
          <a className="cursor-pointer text-[#007bff] text-[14px] font-medium hover:underline">Read All Notifications</a>
        </div>
      </div>
