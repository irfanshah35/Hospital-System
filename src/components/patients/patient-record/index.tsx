      ...
      <div className='px-4 sm:px-6 py-[20px] mt-0'>
        <div className="flex items-center justify-between relative top-[-5px]">
          <div className="flex items-center flex-wrap space-x-2">
            <h1 className="text-[20px] font-semibold">Patient Records</h1>
                      ...
                      <table className="min-w-full divide-y divide-gray-200 hidden md:table">
                        <thead className="bg-white">
                          <tr>
                            ...
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">Full Name</th>
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">Gender</th>
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">Date of Admission</th>
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">Diagnosis</th>
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">Lab Reports</th>
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">Medications</th>
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">Next Follow-Up</th>
                        ...
                        <tbody className={`bg-white divide-y divide-gray-200 transition-all duration-500 ${animate ? "animate-slideDown" : ""}`}>
                          {patients.map((item) => (
                            <tr key={item.id} className="transition-colors duration-150">
                              ...
                              <td className="px-4 text-sm whitespace-nowrap">{item.id}</td>
                            ...
                            <div className="text-sm text-gray-800">
                              ...
                              <div className="flex items-center h-13 space-x-3 border-b border-[#dadada] gap-4">
                                ...
                                <div className="flex items-center">
                                  ...
                                  />
                                  <span className="ml-1">{item.name || "david"}</span>
                                </div>
                              </div>
                              ...
                              <div className="flex items-center h-13 space-x-3 border-b border-[#dadada] gap-4">
                                ...
                                <div className="flex items-center">
                                  <span className="ml-1">{item.department || "Urology"}</span>
                                </div>
                              </div>
                              ...
                              <div className="flex items-center h-13 space-x-3 border-b border-[#dadada] gap-4">
                                ...
                                <div className="flex items-center">
                                  <span className="ml-1">{item.specialization || "Prostate"}</span>
                                </div>
                              </div>
                              ...
                              <div className="flex items-center h-13 space-x-3 border-b border-[#dadada] gap-4">
                                ...
                                <div className="flex items-center">
                                  <span className="ml-1">{item.availability || "Monday to Friday"}</span>
                                </div>
                              </div>
                              ...
                              <div className="flex items-center h-13 space-x-3 border-b border-[#dadada] gap-4">
                                ...
                                <div className="flex items-center">
                                  ...
                                  <span className="ml-1">{item.mobile || "1234567890"}</span>
                                </div>
                              </div>
                              ...
                              <div className="flex items-center h-13 space-x-3 border-b border-[#dadada] gap-4">
                                ...
                                <div className="flex items-center">
                                  <span className="ml-1">{item.degree || "MBBS, MS"}</span>
                                </div>
                              </div>

                              {/* Experience (Years) */}
                              <div className="flex items-center h-13 space-x-3 border-b border-[#dadada] gap-4">
                                <span className="font-semibold w-32">Experience (Years):</span>
                                <div className="flex items-center">
                                  <span className="ml-1">{item.experience || "12"}</span>
                                </div>
                              </div>

                              {/* Consultation Fee */}
                              <div className="flex items-center h-13 space-x-3 border-b border-[#dadada] gap-4">
                                <span className="font-semibold w-32">Consultation Fee:</span>
                                <div className="flex items-center">
                                  <span className="ml-1">{item.consultation_fee || "500"}</span>
                                </div>
                              </div>
                              ...
                              <div className="flex items-center h-13 space-x-3 border-b border-[#dadada] gap-4">
                                ...
                                <div className="flex items-center">
                                  <span className="ml-1">{item.email || "john.doe@hospital.com"}</span>
                                </div>
                              </div>
                              ...
                              {/* Clinic Location */}
                              <div className="flex items-center h-13 space-x-3 border-b border-[#dadada] gap-4">
                                <span className="font-semibold w-32">Clinic Location:</span>
                                <div className="flex items-center">
                                  <span className="ml-1">{item.clinic_location || "City Hospital"}</span>
                                </div>
                              </div>
