                        ...
                        <tbody role='rowgroup' className={`bg-white divide-y divide-gray-200 transition-all duration-500 ${animate ? "animate-slideDown" : ""}`}>
                          {patients.map((item) => (
                            <tr key={item.id} className="transition-colors duration-150 ">
                              ...
                              <td className="px-4 text-sm whitespace-nowrap">GJ88KW7845</td>
                          ...
                          <div key={item.id} className="border-b border-gray-200 py-4">
                            ...
                            <div className="space-y-2 text-sm">
                              ...
                              <div className="flex items-center gap-3 pb-2 border-b border-gray-200">
                                <span className="font-semibold w-28">ID:</span>
                                <span>001</span>
                              </div>
                              ...
                              <div className="flex items-center gap-3 pb-2 border-b border-gray-200">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <span>GJ88KW7845</span>
                                </div>
                              </div>

                              {/* Patient Number */}
                              <div className="flex items-center gap-3 pb-2 border-b border-gray-200">
                                <span className="font-semibold w-28">Vehicle Name:</span>
                                <div className="flex items-center gap-1">
                              ...
                              {/* Gender */}
                              <div className="flex items-center gap-3 pb-2 border-b border-gray-200">
                                <span className="font-semibold w-28">Year Made:</span>
                                <span
                              ...
                              <div className="flex items-center gap-3 pb-2 border-b border-gray-200">
                                ...
                                <span>Ramona Freeman</span>
                              </div>

                              {/* Vehicle Number */}
                              <div className="flex items-center gap-3 pb-2 border-b border-gray-200">
                                <span className="font-semibold w-28">Driver License Number:</span>
                                <span>GT6456345645</span>
                              </div>
                              ...
                              {/* Driver Number */}
                              <div className="flex items-center gap-3 pb-2 border-b border-gray-200">
                                <span className="font-semibold w-28">Vehicle Type</span>
