  ...
  const FloatingInput = ({ 
    ...
    <div className="relative">
        ...
        <>
          <select
            ...
            className={`w-full px-3 py-3 border rounded-md focus:outline-none appearance-none bg-white peer ${
              errors[name] ? "border-red-500" : "border-gray-500 focus:border-blue-500"
            }`}
      ...
      <label className={`absolute left-3 transition-all duration-200 pointer-events-none ${
        fieldStates[name] ? "text-xs -top-2 bg-white px-1 text-blue-500" : "text-gray-500 top-3"
      }`}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <FloatingInput label="Blood Group" name="bloodGroup" type="select"
