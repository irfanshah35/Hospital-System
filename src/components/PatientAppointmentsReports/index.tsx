        ...
        <div className="lg:col-span-2 bg-[var(--header-bg)] rounded-2xl shadow-lg p-4 md:p-6 h-auto md:h-[700px] flex flex-col border border-[var(--border-color)]">
          ...
          <div className="flex border-b border-[var(--border-color)] mb-4 md:mb-6">
            <button
              ...
              className={`flex-1 py-2 md:py-3 px-2 md:px-4 text-center text-sm md:text-base font-semibold transition-colors relative ${activeTab === 'upcoming' ? 'text-[var(--text-primary)]' : 'text-[var(--text-secondary)]'
                }`}
            >
            ...
            <button
              ...
              className={`flex-1 py-2 md:py-3 px-2 md:px-4 text-center text-sm md:text-base font-semibold transition-colors relative ${activeTab === 'past' ? 'text-[var(--text-primary)]' : 'text-[var(--text-secondary)]'
                }`}
            >
