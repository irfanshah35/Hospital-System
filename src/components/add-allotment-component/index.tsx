    ...
    <div className="relative">
      {type === "select" ? (
        <select
          name={name}
          value={formData[name] || ""}
          className={`w-full px-3 py-3 border rounded-md bg-white focus:outline-none appearance-none peer ${
            errors[name]
              ? "border-red-500"
        ...
        <textarea
          ...
          value={formData[name] || ""}
          rows={4}
          className={`w-full px-3 py-3 border rounded-md resize-none focus:outline-none peer ${
            errors[name]
              ? "border-red-500"
              : "border-gray-400 focus:border-blue-500"
          }`}
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              <button
                ...
                className="px-8 py-2 bg-gray-400 text-white rounded-md hover:bg-gray-500 transition disabled:opacity-50 flex items-center gap-2"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
              ...
              <button
                type="button"
                onClick={handleReset}
                className="px-8 py-2 bg-white border border-blue-500 text-blue-500 rounded-md hover:bg-blue-50 transition flex items-center gap-2"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
